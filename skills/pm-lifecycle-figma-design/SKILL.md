...
3. `references/visual-qa.md` before the first screenshot and again before completion.
...
7. Critique hierarchy, clipping, overlap, contrast, density, repetition, narrative continuity and ZDS fit.
